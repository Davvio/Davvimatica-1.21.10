...
//        beNbt.copyFrom(newNbt);
    ...
    {
        // Handle NbtInt directly (new format in 1.21.x)
        if (oldDye instanceof net.minecraft.nbt.NbtInt)
        {
            return ((net.minecraft.nbt.NbtInt) oldDye).intValue();
        }

        // Handle NbtCompound (old format)
        if (oldDye instanceof NbtCompound)
        {
