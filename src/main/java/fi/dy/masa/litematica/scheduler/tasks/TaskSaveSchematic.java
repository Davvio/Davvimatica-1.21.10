...
import fi.dy.masa.litematica.util.SchematicSplitter;
        ...
        if (this.finished)
        {
            ...
            if (this.dir != null)
            {
                if (this.schematic.writeToFile(this.dir, this.fileName, this.overrideFile))
                {
                    ...
                    java.nio.file.Path savedFile = this.dir.resolve(this.fileName.endsWith(LitematicaSchematic.FILE_EXTENSION)
                        ? this.fileName
